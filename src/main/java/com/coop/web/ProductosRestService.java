...
@RestController
@RequestMapping(Constantes.URL_API_PRODUCTOS)
...
private Logger log= LoggerFactory.getLogger(this.getClass());
	...
	public ResponseEntity<String> updatePrecio(
			@RequestParam(value = "precio_") double precio,@PathVariable("id") long id) throws BusinessException{
		try {
	...
	public ResponseEntity<List<Producto>> listPageable(
		...
		log.info("se está ejecutando el proceso");
